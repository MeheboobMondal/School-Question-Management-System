...
while($row = mysqli_fetch_array($result1)){
    ...
    $sql = "SELECT subject_mas.degree_nm FROM subject_mas 
        INNER JOIN question_mas ON question_mas.subject_id = subject_mas.degree_id
    WHERE question_mas.class_id = '$classid'";
